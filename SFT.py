...
from model import BigPatrickPreview
...
def init_model(lm_config):
    tokenizer = AutoTokenizer.from_pretrained('BigPatrickPreview_tokenizer')
    model = BigPatrickPreview(lm_config)
...
if __name__ == "__main__":
     ...
     parser.add_argument("--wandb_project", type=str, default="BigPatrickPreview-SFT")
     ...
     args.wandb_run_name = f"BigPatrickPreview-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
